...
// route should have; scoped to the calling admin's own org instead, which
...
// visibility an admin can check, with reindexSearch.ts as the actual fix
// once a real mismatch is noticed (e.g. after an Elasticsearch instance
